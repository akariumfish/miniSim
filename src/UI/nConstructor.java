...
public class nConstructor {
  ...
  nConstructor(nTheme _g, float s) {
    ...
    theme.addModel("Cursor", theme.newWidget("ref")
      ...
      .setOutlineColor(app.color(10, 160, 220))
      .setOutlineWeight(ref_size / 10)
      .setOutline(true)
      .setOutlineConstant(true)
      );
    theme.addModel("Pointer", theme.newWidget("ref")
      .setStandbyColor(app.color(0, 80, 120))
      .setHoveredColor(app.color(0, 50, 70))
      .setClickedColor(app.color(10, 140, 220))
      .setOutlineColor(app.color(20, 200, 220))
      .setOutlineWeight(ref_size / 10)
      .setOutline(true)
      .setOutlineConstant(true)
      );
  ...
  void make(String base) {
    ...
    do_sizes(base, "-S3.75/0.75", ref_size*3.75F, ref_size*0.75F);
    ...
    do_places(base, "-S2/1-P1", ref_size*0.4F, 0, ref_size*2.0F, ref_size);
