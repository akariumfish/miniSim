...
//			  pile.drawables.remove(this); 
	  ...
	  public Drawable setPile(Drawing_pile p) {
	    pile = p; if (!pile.drawables.contains(this)) pile.drawables.add(this);
	    return this; }
	  public Drawable() {}
	  ...
	  public Drawable(Drawing_pile p, int l) {
	    ...
	    pile = p; pile.drawables.add(this); }
	  public void clear() { 
		  if (pile != null) pile.drawables.remove(this); 
	  }
	  public void toLayerTop() { 
		  if (pile.drawables.contains(this)) {
			  pile.drawables.remove(this); pile.drawables.add(0, this); 
		  }
	  }
	  public void toLayerBottom() { 
		  if (pile.drawables.contains(this)) {
			  pile.drawables.remove(this); pile.drawables.add(this); 
		  }
	  }
