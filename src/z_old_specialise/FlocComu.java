...
//    l.add(-pos.x, -pos.y);
//    float r1 = mapToCircularValues(mov.heading(), l.heading(), s, -PConstants.PI, PConstants.PI);
//    mov.x = speed; mov.y = 0;
//    mov.rotate(r1);
//  }
//  void headTo(float l, float s) {
//    float r1 = mapToCircularValues(mov.heading(), l, s, -PConstants.PI, PConstants.PI);
//    mov.x = speed; mov.y = 0;
//    mov.rotate(r1);
//  }
//  
