...
public class MGrowerGroup extends MGroup { 
	...
	public void comPanelBuild(nFrontPanel sim_front) {
	    ...
	    tab.getShelf()
	      ...
	      .addSeparator(0.125)
	      .addDrawerActFactValue("floc", create_floc, floc_prob, 2, 10, 1, false)
	      .addSeparator(0.125)
	      .addDrawerButton(srun_killg, 10, 1)
	      .addSeparator(0.125)
	      .addDrawerFactValue(TEEN_AGE, 2, 10, 1)
	      .addSeparator(0.125)
	      .addDrawerActFactValue("age", AGE_ON, OLD_AGE, 2, 10, 1, false)
	      .addSeparator(0.125)
	      .addDrawerActFactValue("grow", growP.ON, growP.DIFFICULTY, 2, 10, 1, false)
	      .addSeparator(0.125)
	      .addDrawerActFactValue("Sprout", sproutP.ON, sproutP.DIFFICULTY, 2, 10, 1, false)
	      .addSeparator(0.125)
	      .addDrawerActFactValue("leaf", leafP.ON, leafP.DIFFICULTY, 2, 10, 1, false)
	      .addSeparator(0.125)
	      .addDrawerActFactValue("stop", stopP.ON, stopP.DIFFICULTY, 2, 10, 1, false)
	      .addSeparator(0.125)
	      .addDrawerActFactValue("die", dieP.ON, dieP.DIFFICULTY, 2, 10, 1, false)
	      .addSeparator(0.125)
	      ;
