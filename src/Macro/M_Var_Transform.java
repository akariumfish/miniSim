...
class MCalc extends Macro_Bloc {
	  static class MCalc_Builder extends MAbstract_Builder {
		  MCalc_Builder() { super("calc", "Calculator", "", "Data"); }
		  MCalc build(Macro_Sheet s, sValueBloc b) { MCalc m = new MCalc(s, b); return m; }
	  }
  Macro_Connexion in1, in2, out;
